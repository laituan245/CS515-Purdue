...
function solve_poisson(n)
    return @timed poisson_multigrid_residual(n, n, 25)
end
...
savefig(plot(ns, measured_times, xlabel="Log2(n)", ylabel="Log2(Times measured in seconds)", linewidth=2, label="Time"), "time_analysis_part_10.png")
